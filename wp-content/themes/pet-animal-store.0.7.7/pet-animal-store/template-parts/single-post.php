...
<article>
	...
	<?php if( get_theme_mod( 'pet_animal_store_single_post_date_hide',true) != '' || get_theme_mod( 'pet_animal_store_comment_hide',true) != '' || get_theme_mod( 'pet_animal_store_author_hide',true) != '' || get_theme_mod( 'pet_animal_store_time_hide',true) != '') { ?>
